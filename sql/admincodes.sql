...
DROP COLUMN IF EXISTS admin1code_full,
DROP COLUMN IF EXISTS admin2code_full,
DROP COLUMN IF EXISTS admin3code_full,
DROP COLUMN IF EXISTS admin1nameascii,
DROP COLUMN IF EXISTS admin2nameascii,
DROP COLUMN IF EXISTS admin3nameascii
;

ALTER TABLE postalcodes
ADD COLUMN admin1code_full VARCHAR(100) DEFAULT NULL,
ADD COLUMN admin2code_full VARCHAR(100) DEFAULT NULL,
ADD COLUMN admin3code_full VARCHAR(100) DEFAULT NULL,
ADD COLUMN admin1nameascii VARCHAR(100) DEFAULT NULL,
ADD COLUMN admin2nameascii VARCHAR(100) DEFAULT NULL,
ADD COLUMN admin3nameascii VARCHAR(100) DEFAULT NULL
;
...
DROP INDEX IF EXISTS postalcodes_admin1code_notnull_idx;
DROP INDEX IF EXISTS postalcodes_admin2code_notnull_idx;
DROP INDEX IF EXISTS postalcodes_admin3code_notnull_idx;
